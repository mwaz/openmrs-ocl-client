...
validate = (data) => {
  ...
  if (!data.public_access) {
    errors.public_access = 'Kindly select the Permissions for your dictionary';
  }
  ...
  return (
    ...
    <div className="col-sm-5">
      ...
      >
            ...
            <div className="row">
              <div className="col-md-8">
                ...
                <FormGroup
                  ...
                  title="Short Code"
                >
                    Short Code: e.g Community-MCH, Only Alphanumeric Characters Allowed
        ...
        <Modal.Footer>
          <Button className="btn btn-outline-info" id="addDictionary" onClick={this.onSubmit}>{this.props.buttonname}</Button>
          <Button
...
export default connect(mapStateToProps, { fetchingOrganizations })(DictionaryModal);
